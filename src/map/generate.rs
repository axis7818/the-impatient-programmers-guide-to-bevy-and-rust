...
pub const GRID_Z: u32 = 5;

/// Size of the map in pixels
pub const MAP_PIXEL_DIMENSIONS: UVec2 =
    UVec2::new(TILE_SIZE as u32 * GRID_X, TILE_SIZE as u32 * GRID_Y);
...
pub fn setup_generator(
    ...
    // Rules Initialization - Get tile definitions and connection rules
    ...
    // Grid - Create 3D world space with wrapping behavior (false, false, false)
    let grid = CartesianGrid::new_cartesian_3d(GRID_X, GRID_Y, GRID_Z, false, false, false);

    // Configuring the Algorithm - Set up WFC behavior
    ...
    // Loading Assets - Load sprite atlas and convert to renderable assets
    let tilemap_handles =
    ...
    // Spawning the Generator - Create entity with Transform and NodesSpawner
    commands.spawn((
